...
//       );
//       // Aqui você pode redirecionar para outra tela com Navigator
...
//                     backgroundColor: const Color(0xFF00D39A), // MUDADO AQUI
...
//       filled: true,
//       fillColor: const Color(0xFFECE7E3),
...
class CoriggeLoginScreen extends StatelessWidget {
  const CoriggeLoginScreen({super.key});
  ...
  return Row(
    ...
    children: [
      ...
      Container(
        ...
        height: 250,
        decoration: BoxDecoration(
          color: const Color(0xFF8B4513), // Cor de fundo da imagem do gabarito
        ...
        child: Center(
          child:
            ...
            child: const Icon(Icons.assignment, size: 80, color: Color(0xFF8B4513)),
          ),
        ),
      ),
...
Widget _buildSignInButton() {
  return ElevatedButton(
    ...
    child: Row(
      mainAxisSize: MainAxisSize.min, // Para que o Row não ocupe toda a largura
      children: [
